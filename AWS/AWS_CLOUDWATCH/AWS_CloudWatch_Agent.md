...
Download the cloud watch agent from s3
...
We need to write a config file in which we will specify the metrics we need to put.
...
Then after specifying the metric then we just need to start the cloud watch agent
